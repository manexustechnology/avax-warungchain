...
import { sendTokens } from '@/utils/avalanche';
  ...
  const handleExecutePayment = async () => {
    ...
    if (balance !== null && balance < paymentInfo.amount) {
      toast({
        ...
        description: `You need at least ${paymentInfo.amount} AVAX to complete this payment.`,
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      // Call Avalanche blockchain utility for sending tokens (only 2 arguments needed)
      ...
      if (result.success && result.txHash) {
        ...
        toast({
          ...
          description: "Your AVAX payment has been processed successfully.",
        });
      } else {
        ...
        <CardHeader>
          ...
          <CardDescription>
            {isSuccess 
              ...
              : "Review and confirm your AVAX payment"}
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4 p-4 bg-secondary/20 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">{paymentInfo.amount} AVAX</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              {balance !== null && (
                <div className="mt-2 text-sm pl-4">
                  ...
                  <span>{balance.toFixed(4)} AVAX</span>
                </div>
              )}
            </div>
          )}
